        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/appmattus/leaktracker")
                }
            }
        }
    }
...
configure<BintrayExtension> {
    ...
    pkg.apply {
        ...
        websiteUrl = "https://github.com/appmattus/leaktracker"
        issueTrackerUrl = "https://github.com/appmattus/leaktracker/issues"
        vcsUrl = "https://github.com/appmattus/leaktracker"
        githubRepo = "appmattus/leaktracker"
